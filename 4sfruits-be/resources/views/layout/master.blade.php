...
<body>
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a>4SFRUITS ADMIN</a></div>
            <div class="nav-right ">
            ...
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            <li style="color: #787272; padding: 5px 0; margin-left: -8px;">Cấp 1</li>
                            <li><a href="{{ route('level1.create') }}">Thêm mới</a></li>
                            <li><a href="{{ route('level1.index') }}">Danh sách</a></li>
                        </ul>

                        <ul class="sub-menu">
                            <li style="color: #787272; padding: 5px 0; margin-left: -8px;">Cấp 2</li>
                            <li><a href="{{ route('level2.create') }}">Thêm mới</a></li>
                            <li><a href="{{ route('level2.index') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link">
                        <a href="?view=list-post">
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{ route('product-cat.index') }}">Danh mục</a></li>
                        </ul>
                    </li>
                    {{-- <li class="nav-link">
