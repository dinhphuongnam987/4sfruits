                ...
                <div class="col-6 mt-3 ml-2 position-relative">
                    ...
                    <form action="{{ route('post.update', $id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="title" placeholder="Tiêu bài viết" value="{{$old_post['title']}}">
                        ...
                        <div class="form-group">
                            <div class="form-floating">
                                <textarea class="form-control" name="description" placeholder="Mô tả" id="floatingTextarea2" style="height: 100px">{{ $old_post['description'] }}</textarea>
                            </div>
                            <small class="form-text text-muted">
                                @error('description')
                                    <small class="form-text text-danger">{{ $message }}</small>
                        ...
                        <button type="submit" class="btn btn-primary float-right" name="btn_update_post" value="Update post">Cập nhập bài viết</button>
                    </form>
                </div>
            </div>
        </div>
